...
public class AnsiColor {
    ...
    static {
        ...
        String testSuiteColorOutput = System.getProperty("test.engine.color");
        if ("on".equalsIgnoreCase(testSuiteColorOutput)) {
            ANSI_COLOR_SUPPORTED = true;
        } else if ("off".equalsIgnoreCase(testSuiteColorOutput)) {
